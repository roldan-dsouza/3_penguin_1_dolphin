...
import { Settings, Upload, FileText, Clock, Trash2, BookOpen, LogOut } from "lucide-react";
        ...
        <div className="min-h-screen transition-colors duration-400" style={{ backgroundColor: preset.bg, color: preset.text }}>
            ...
            <main className="max-w-5xl mx-auto px-6 py-10">
                ...
                <motion.section initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
                    ...
                    >
                        ...
                        <p className="text-lg font-semibold mb-1">
                            {dragOver ? "Drop your file here!" : "Drag & drop a .txt file here"}
                        </p>
                ...
                >
                    ...
                    {notes.length === 0 ? (
                        <Card className="border-none" style={{ backgroundColor: `${preset.text}08` }}>
                            <CardContent className="p-8 text-center">
                                <FileText className="w-12 h-12 mx-auto mb-4 opacity-20" />
                                <p className="text-lg font-medium opacity-40">No notes yet</p>
                                <p className="text-sm opacity-30 mt-1">Upload a .txt file to get started</p>
                            </CardContent>
                        </Card>
                    ) : (
